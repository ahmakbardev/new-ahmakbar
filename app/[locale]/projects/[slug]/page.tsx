  ...
  return (
    <section className="px-10 py-10 mt-28 bg-white rounded-4xl h-fit max-w-6xl mx-auto">
      <button
        ...
        className="fixed top-5 left-5 z-50 px-4 py-2 cursor-pointer bg-white text-gray-800 rounded-xl shadow-md hover:bg-gray-100 transition-colors duration-200 text-sm flex items-center gap-2"
      >
